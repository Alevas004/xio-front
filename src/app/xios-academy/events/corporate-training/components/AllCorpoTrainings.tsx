...
const AllTrainings = ({ training }: TrainingsProps) => {
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center">
            ...
            <p className="text-gray-600 text-lg">
              Estamos preparando increíbles capacitaciones para ti. ¡Mantente atento!
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="relative text-white py-20">
        ...
        <div className="relative container mx-auto px-4  flex flex-col items-center justify-center">
          ...
          <p className=" md:text-2xl text-piel-claro max-w-3xl leading-relaxed">
            Explora nuestros programas de capacitación diseñados para potenciar
              ...
              <div className="relative h-48 bg-gradient-2 flex items-center justify-center">
                ...
                {training.price && (
                  <div className="absolute bottom-4 right-4 bg-verde-oscuro text-white rounded-xl px-3 py-2">
                    <span className="text-sm font-bold">$ {formatPrice(training.price)}</span>
                  </div>
                )}
              </div>
                ...
                <div className="space-y-2 mb-6">
                  ...
                  {training.speakers && (
                    <div className="flex items-center text-sm text-gray-500">
                      ...
                      <span className="text-start">Instructores: {training.speakers.join(", ")}</span>
                    </div>
                  )}
