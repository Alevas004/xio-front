...
const XiosAcademyHome = () => {
  const { data: courses } = useGet("/xios-academy/courses", { withAuth: true });
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="text-center">
                <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-verde-oscuro to-verde-claro rounded-2xl">
                  <stat.icon className="w-8 h-8 text-verde-oscuro" />
                </div>
            ...
            {learningPaths.map((path, index) => (
              ...
              >
                ...
                <div className="relative ">
                  ...
                  >
                    <path.icon className="w-8 h-8 text-piel-blanco" />
                  </div>
...
export default XiosAcademyHome;
