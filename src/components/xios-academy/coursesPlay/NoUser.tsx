...
const NoUser = ({ courseData, isEnrolled, setIsEnrolled }: NoUserProps) => {
                  ...
                  <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                    <div className="flex items-center gap-2 text-green-700">
                      ...
                      <span className="font-medium">
                        {courseStats.previewLessons} lecciones disponibles para
      ...
      <div className="container mx-auto px-6 py-16">
        <div className="bg-gradient-to-r from-verde-oscuro to-piel-oscuro rounded-2xl p-8 lg:p-12 text-center text-white">
          ...
          <p className="text-xl text-piel-blanco/90 mb-8 max-w-2xl mx-auto">
            {courseData.academy
              ? `Únete a ${
                  courseData.academy.enrolled || 0
                } personas que ya están transformando sus vidas con este workshop.`
              : "Únete a más de 1,200 terapeutas que ya han construido negocios prósperos y auténticos."}
          </p>

          {/* Stats rápidas */}
          <div className="flex justify-center gap-8 mb-8 text-piel-blanco/90">
            <div className="text-center">
          ...
          <button className="bg-white text-verde-oscuro px-8 py-4 rounded-xl font-bold text-lg hover:bg-piel-blanco transition-all duration-300 hover:scale-105">
            {courseData.is_free
              ? "Inscribirse Gratis"
