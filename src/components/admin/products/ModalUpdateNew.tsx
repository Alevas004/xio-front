        ...
        <div className="max-h-[calc(90vh-140px)] overflow-y-auto">
          <form
            onSubmit={handleSubmit((data) => {
              // Fill missing required fields with fallback values from product
              const completeData: ProductUpdate = {
                id: product.id,
                ...
                caracteristics: data.caracteristics ?? product.caracteristics,
                includes: data.includes ?? product.includes,
                isActive: data.isActive ?? product.isActive,
                isFeatured: data.isFeatured ?? product.isFeatured,
                hasDiscount: data.hasDiscount ?? product.hasDiscount,
                isNew: data.isNew ?? product.isNew,
                isSold: data.isSold ?? product.isSold,
                discountValue: data.discountValue ?? product.discountValue,
              };
